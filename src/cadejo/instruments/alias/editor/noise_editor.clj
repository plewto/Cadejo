  ...
  (let [param-nse-crackle :noise-param
        ...
        sync-fn (fn [dmap]
                  (let [crackle (param-nse-crackle dmap)
                        ...
                        d1 (param-nse-d1 dmap)
                        l1 (param-nse-l1 dmap)
                        d2 (param-nse-d2 dmap)
                        l2 (param-nse-l2 dmap)
                        pan1 (param-nse-pan dmap)
                        car (param-rm-car dmap)
                        mod (param-rm-mod dmap)
                        mix2 (param-rm-mix dmap)
                        d3 (param-rm-d1 dmap)
                        l3 (param-rm-l1 dmap)
                        d4 (param-rm-d2 dmap)
                        l4 (param-rm-l2 dmap)
                        pan2 (param-rm-pan dmap)
                        lp (param-nse-lp dmap)
                        hp (param-nse-hp dmap)
                        s1 (param-nse-s1 dmap)
                        s2 (param-nse-s2 dmap)
                        s3 (param-rm-s1 dmap)
                        s4 (param-rm-s2 dmap)]
                    (slider-value! s-nse-crackle crackle)
                    (slider-value! s-nse-mix mix1)
                    (slider-value! s-nse-d1 d1)
                    (slider-value! s-nse-l1 l1)
                    (slider-value! s-nse-d2 d2)
                    (slider-value! s-nse-l2 l2)
                    (slider-value! s-nse-pan pan1)
                    (slider-value! s-rm-car car)
                    (slider-value! s-rm-mod mod)
                    (slider-value! s-rm-mix mix2)
                    (slider-value! s-rm-d1 d3)
                    (slider-value! s-rm-l1 l3)
                    (slider-value! s-rm-d2 d4)
                    (slider-value! s-rm-l2 l4)
                    (slider-value! s-rm-pan pan2)
                    (dslider/set-dual-slider-values! ds-filter hp lp false)
                    (msb-state! b-nse-s1 s1)
                    (msb-state! b-nse-s2 s2)
                    (msb-state! b-rm-s1 s3)
                    (msb-state! b-rm-s2 s4)))]
    sync-fn))
