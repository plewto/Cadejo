...
(defn alias-editor [performance]
  (let [ied (ied/instrument-editor performance)
        osc1 (osced/osc1-editor performance ied)
        osc2 (osced/osc2-editor performance ied)
        osc3 (osced/osc3-editor performance ied)
    ...
    (.add-sub-editor! ied "OSC 1" osc1)
    (.add-sub-editor! ied "OSC 2" osc2)
    (.add-sub-editor! ied "OSC 3" osc3)
