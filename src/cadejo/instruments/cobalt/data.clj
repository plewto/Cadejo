...
(save-program 0 "Alpha"
   (cobalt (port-time 0.00)
           ...
           (lfo1    5.000 :cca   0.00 :prss 0.00)
           (lfo2    1.000 :xenv  0.00 :cca   0.00 :ccb  0.00)
           (lfo3    0.100 :xenv  0.00 :cca   0.00 :ccb  0.00)
           (op1 1.000 1.000
                :lfo1 1.00 :vel +0.00 :prss +0.00 :cca   0.00 :ccb   0.00 
                :penv  0.00
                :env [:att 0.000 :dcy1 0.000 :dcy2 0.000 :rel 4.000
                      :peak 1.00 :bp   1.00  :sus  1.00]
           ...
           (op6 6.000 0.0167
                ...
                :env [:att 0.000 :dcy1 0.000 :dcy2 0.000 :rel 1.000
                      :peak 1.00 :bp   1.00  :sus  1.00])
           (op7 7.000 0.0143
                :lfo1 0.00 :vel +0.00 :prss +0.00 :cca   0.00 :ccb   0.00 
                :penv  0.00
                :env [:att 0.000 :dcy1 0.000 :dcy2 0.000 :rel 1.000
                      :peak 1.00 :bp   1.00  :sus  1.00])
           (op8 8.000 0.0125
           ...
           (buzz  12.000 0.0010 
                  ...
                  :env [:att 0.000 :dcy1 0.000 :dcy2 0.000 :rel 1.000
                        :peak 1.00 :bp   1.00  :sus  1.00]
                  :key 60 :left   0 :right   0)
           (lp-filter :freq  [12000 :track   1 :env +0.00 :prss +0.00 
                              :cca +0.00 :ccb +0.00]
           ...
           (delay2  :time [0.3333 :lfo2 0.000 :lfo3 0.000 :xenv 0.000]
                    ...
                    :pan  [+0.7   :lfo2 0.000 :lfo3 0.000 :xenv 0.000]
                    :fb   0.50 :xfb 0.00)
           (amp -6  :vel 0.00 :dry 0 :dry-pan 0.0 :cc7 0)))
