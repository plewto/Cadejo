...
(defn- bypass-filter-mode [env]
  [(prog/lp-filter :freq [con/max-filter-cutoff :track 0 :env 0 :prss 0 :cca 0 :ccb 0]
                   :res [0 :cca 0 :ccb 0]
                   :env env
                   :mode -1)
...
(defn- lowpass-filter-mode1 [env]
  (let [track (int (rand-nth [0 0 0 0 1 2]))
    ...
    [(prog/lp-filter :freq [freq :track track :env env-mod :prss 0.00 :cca 0.00 :ccb 0.00]
