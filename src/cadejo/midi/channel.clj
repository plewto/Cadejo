...
(deftype Channel [parent children* properties* 
                  bend-properties pressure-properties
...
(defn channel [parent ci]
  ...
  (let [children (atom {})
        ...
        cobj (Channel. parent
                       children
                       properties
                       (cadejo.midi.pitch-bend/bend-properties)
                       (cadejo.midi.pressure/pressure-properties)
                       (cadejo.midi.cc/controller-distributor))]
    cobj))
